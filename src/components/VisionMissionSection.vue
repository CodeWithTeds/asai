  ...
  <div id="vision" class="vmv-wrapper">
    ...
    <section class="vmv-section vmv-section--vision">
      ...
      <div class="vmv-content" :ref="(el) => setPanelRef(el, 0)">
        ...
        <h2 class="vmv-heading">Setting the standard<br>for security excellence</h2>
        <ul class="vmv-list">
          <li v-for="(point, i) in visionPoints" :key="i">{{ point }}</li>
        </ul>
      </div>
    </section>
    ...
    <section class="vmv-section vmv-section--mission">
      ...
      <div class="vmv-content" :ref="(el) => setPanelRef(el, 1)">
        ...
        <h2 class="vmv-heading">A trustworthy partner<br>for business development</h2>
        <p class="vmv-text">
    ...
    <section class="vmv-section vmv-section--values">
      ...
      <div class="vmv-content" :ref="(el) => setPanelRef(el, 2)">
        ...
        <h2 class="vmv-heading">The principles that<br>drive everything we do</h2>
        <div class="vmv-values-list">
          <span v-for="(val, i) in values" :key="i" class="vmv-value-tag">{{ val }}</span>
        </div>
      </div>
    </section>
  </div>
